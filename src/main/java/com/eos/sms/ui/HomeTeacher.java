...
import com.eos.sms.service.CourseService;
import com.eos.sms.service.GradeService;
import com.eos.sms.service.TeacherService;
...
//        frame.pack();
    ...
    private class TeacherInfoModel extends AbstractTableModel {
        ...
        Map<String, Object> map = teacherService.findTeacherMapById(teacher.getId());
        ...
        private void save() {
            teacherService.saveTeacher(map);
        }
    ...
    private class CourseInfoModel extends AbstractTableModel {
        ...
        private List<Map<String,Object>> getAllCourses() {
            return  courseService.findAllCoursesByTeacherId(teacher.getId());
        }
