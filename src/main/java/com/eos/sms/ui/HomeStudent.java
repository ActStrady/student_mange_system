...
public class HomeStudent {
    ...
    public HomeStudent() {
        ...
        Student databaseStudent = studentInfoService.findStudentInfoByUsername(sessionStudent.getUsername());
...
//        frame.pack();
        ...
        modifyButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean flag = studentInfoService.saveStudentInfo(preModifyStudent);
                if (flag == true) {
    ...
    private class ChooseCourseModel extends AbstractTableModel {
        ...
        public boolean saveChooseCourse(int courseId) {
            boolean flag = chooseCourseService.saveChoosen(student.getId(), courseId);
            updateChoosenInfo();
        ...
        public List<Map<String, Object>> getALlChooseCourse() {
            return chooseCourseService.findAllChooseCourse(student.getId());
        }
    ...
    private class GradesQueryModel extends AbstractTableModel {
        ...
        private List<Map<String, Object>> list = gradeService.getGradesByStudentId(student.getId());
