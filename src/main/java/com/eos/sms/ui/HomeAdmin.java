...
//        frame.pack();
        ...
        addOneRowCourseButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!(table2.getSelectedRow() > -1) || table2.getValueAt(table2.getSelectedRow(),
                        3) == null) {
                    JOptionPane.showMessageDialog(frame, "请在教师表中选择一项有教师姓名的行", "提示",
        ...
        deleteOneStudentRowButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (table3.getSelectedRow() > -1) {
                    ...
                    JOptionPane.showMessageDialog(frame, "请选择一条记录", "提示",
                            JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
        ...
        cleanButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int courseId =
                        Integer.parseInt(importedGradeModel.getValueAt(table4.getSelectedRow(),
                                0).toString().trim());
        ...
        table5.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                int courseId =
                        Integer.parseInt(courseInfoModel.getValueAt(table5.getSelectedRow(), 0).toString().trim());
...
//                private StudentStatisticModel studentStatisticModel;
        ...
        statisticButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (index == 0) { // 按课程查询
                    ...
                    String courseName = courseStatisticModel.getValueAt(course.getSelectedRow(),
                            0).toString();
                    ...
                    int classCode =
                            Integer.parseInt(classStatisticModel.getValueAt(studentClass.getSelectedRow(), 0).toString());
                    ...
                    String studentCode =
                            studentStatisticModel.getValueAt(student.getSelectedRow(), 0).toString();
                    ...
                    String academicQuery = timeStatisticModel.getValueAt(time.getSelectedRow(),
                            0).toString();
                    String termQuery =
                            timeStatisticModel.getValueAt(time.getSelectedRow(), 1).toString();
    ...
    private class TeacherModel extends AbstractTableModel {
        ...
        List<Map<String, Object>> list = teacherService.findAllTeachers();
        ...
        public void save() {
            for (int i = 0; i < list.size(); i++) {
                boolean flag = teacherService.saveTeacher(list.get(i));
            }
            // 更新当前数据源
            list = teacherService.findAllTeachers();
            fireTableDataChanged();
        ...
        public void remove(int rowIndex) {
            ...
            if (map.containsKey("id")) {
                teacherService.removeTeacher(Integer.parseInt(map.get("id").toString()));
            }
    ...
    private class StudentInfoModel extends AbstractTableModel {
        ...
        String[] columnStrings = {"id", "username", "password", "studentCode", "name",
                "studentClass", "age", "sex", "birthday", "address", "phone", "email"};
        String[] columnShowStrings = {"编号", "用户名", "密码", "学号", "姓名", "班级", "年龄", "性别", "生日", "地址"
                , "电话", "邮箱"};
        ...
        public void saveStudentTable() {
            ...
            for (int i = 0; i < list.size(); i++) {
                studentInfoService.saveStudentInfoByMap(list.get(i));
            }
        ...
        public void removeStudentWithIndex(int index) {
            ...
            if (map.containsKey("id")) {
                boolean flag =
                        studentInfoService.deleteStudentById(Integer.parseInt(map.get("id").toString().trim()));
                if (flag == true) {
                    list.remove(index);
                }
            } else {
    ...
    private class ImportedGradeModel extends AbstractTableModel {
        ...
        String[] columnStrings = {"id", "courseName", "academicYear", "term", "name",
                "commitStatus"};
        ...
        public void cleanCommitStatusByCourseId(int id) {
            courseService.clearCommitStautsByCourseId(id);
    ...
    private class GradeInputModel extends AbstractTableModel {
        ...
        public List<Map<String, Object>> getAllStudentByCourseId(int courseId, boolean useDraft) {
            if (useDraft == true) {
                return courseService.findAllStudentWithGradeDraftByCourseId(courseId);
            } else {
                return courseService.findAllStudentWithGradeByCourseId(courseId);
            }
        ...
        public boolean commitGrades() {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (map.get("score") == null || map.get("score") == "") {
                    JOptionPane.showMessageDialog(frame, "请将成绩填写完整后再提交", "提示",
                            JOptionPane.INFORMATION_MESSAGE);
                    return false;
                }
            }
            ...
            for (int i = 0; i < list.size(); i++) {
                Map<String, Object> map = list.get(i);
                gradeService.saveGrade(map);
                courseService.commitCourseByCourseId(courseId);
        ...
        public void saveToDraft() {
            for (int i = 0; i < list.size(); i++) {
                gradeService.saveGradeToDraft(list.get(i));
            }

            courseService.draftCourseByCourseId(courseId);
    ...
    private class CourseStatisticModel extends AbstractTableModel {
        ...
        private List<Map<String, Object>> list = statisticService.getAllCourses();
        ...
        private Map<String, Object> getData(String courseName) {
            ...
            return statisticService.getCourseStatisticalByCourseName(courseName).get(0);
        }

        public void update() {
            list = statisticService.getAllCourses();
            fireTableDataChanged();
    ...
    private class StudentStatisticModel extends AbstractTableModel {
        ...
        private StatisticService statisticService = new StatisticService();
        private List<Map<String, Object>> list = statisticService.getAllStudents();
        ...
        private Map<String, Object> getData(String studentCode) {
            ...
            return statisticService.getStudentStatisticalByStudentCode(studentCode).get(0);
        }

        public void update() {
            list = statisticService.getAllStudents();
            fireTableDataChanged();
    ...
    private class ClassStatisticModel extends AbstractTableModel {
        ...
        private StatisticService statisticService = new StatisticService();
        private List<Map<String, Object>> list = statisticService.getAllClasses();
        ...
        private Map<String, Object> getData(int studentClass) {
            ...
            return statisticService.getClassStatisticalByClass(studentClass).get(0);
        }

        public void update() {
            list = statisticService.getAllClasses();
            fireTableDataChanged();
    ...
    private class TimeStatisticModel extends AbstractTableModel {
        ...
        private StatisticService statisticService = new StatisticService();
        private List<Map<String, Object>> list = statisticService.getAllTimes();
        ...
        private Map<String, Object> getData(String academicYear, String term) {
            ...
            return statisticService.getTimeStatisticalTime(academicYear, term).get(0);
        }

        public void update() {
            list = statisticService.getAllTimes();
            fireTableDataChanged();
